      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-white/5">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <p className="text-sm text-gray-400 max-w-sm leading-relaxed">
              Next-generation digital solutions. We engineer high-performance web applications, AI automations, and scalable SaaS platforms with absolute precision.
            </p>
            {/* Social Icons */}
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-semibold uppercase tracking-widest text-white">Services</h3>
            <ul className="space-y-2.5 text-sm">
              <li><a href="#" className="hover:text-white transition-colors duration-200">AI Automations</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">SaaS Development</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Web & App Dev</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors duration-200">Build in Public</a></li>
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-semibold uppercase tracking-widest text-white">Agency Status</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 gap-4 text-xs text-gray-500">
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-4 text-center sm:text-left">
            <p>© {new Date().getFullYear()} HUZAIFA.DEVTECH. All rights reserved.</p>
          ...
          >
            <span className="tracking-wider uppercase text-[10px] font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">Back to top</span>
            <div className="p-2 rounded-lg bg-white/5 border border-white/5 group-hover:border-white/10 transition">
              <FaArrowUp size={12} className="group-hover:-translate-y-0.5 transition-transform duration-200" />
            </div>
          </button>
        </div>
